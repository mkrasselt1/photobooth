...
return [
    ...
    'coinacceptor' => [
        'view' => 'advanced',
        'coinacceptor_enabled' => [
            'view' => 'basic',
            'type' => 'checkbox',
            'name' => 'coinacceptor[enabled]',
            'value' => $config['coinacceptor']['enabled'],
        ],
        'coinacceptor_serial_port' => [
            'view' => 'basic',
            'type' => 'input',
            'placeholder' => $defaultConfig['coinacceptor']['serial_port'],
            'name' => 'coinacceptor[serial_port]',
            'value' => $config['coinacceptor']['serial_port'],
        ],
        'coinacceptor_baud_rate' => [
            'view' => 'advanced',
            'type' => 'select',
            'name' => 'coinacceptor[baud_rate]',
            'placeholder' => $defaultConfig['coinacceptor']['baud_rate'],
            'options' => [
                '1200' => '1200',
                '2400' => '2400',
                '4800' => '4800',
            ...
            'value' => (string) $config['coinacceptor']['baud_rate'],
        ],
        'coinacceptor_protocol' => [
            'view' => 'advanced',
            'type' => 'select',
            'name' => 'coinacceptor[protocol]',
            'placeholder' => $defaultConfig['coinacceptor']['protocol'],
            'options' => [
                'pulse' => 'Pulse count',
                'byte_value' => 'Byte value',
                'ascii' => 'ASCII / text',
            ],
            'value' => $config['coinacceptor']['protocol'],
        ],
        'coinacceptor_pulse_value' => [
            'view' => 'advanced',
            'type' => 'number',
            'placeholder' => $defaultConfig['coinacceptor']['pulse_value'],
            'name' => 'coinacceptor[pulse_value]',
            'value' => $config['coinacceptor']['pulse_value'],
        ],
        'coinacceptor_serverip' => [
            'view' => 'advanced',
            'type' => 'input',
            'placeholder' => $defaultConfig['coinacceptor']['serverip'],
            'name' => 'coinacceptor[serverip]',
            'value' => $config['coinacceptor']['serverip'],
        ],
        'coinacceptor_port' => [
            'view' => 'advanced',
            'type' => 'number',
            'placeholder' => $defaultConfig['coinacceptor']['port'],
            'name' => 'coinacceptor[port]',
            'value' => $config['coinacceptor']['port'],
        ],
        'coinacceptor_price_picture' => [
            'view' => 'basic',
            'type' => 'number',
            'placeholder' => $defaultConfig['coinacceptor']['price_picture'],
            'name' => 'coinacceptor[price_picture]',
            'value' => $config['coinacceptor']['price_picture'],
        ],
        'coinacceptor_price_print' => [
            'view' => 'basic',
            'type' => 'number',
            'placeholder' => $defaultConfig['coinacceptor']['price_print'],
            'name' => 'coinacceptor[price_print]',
            'value' => $config['coinacceptor']['price_print'],
        ],
        'coinacceptor_show_credits' => [
            'view' => 'basic',
            'type' => 'checkbox',
            'name' => 'coinacceptor[show_credits]',
            'value' => $config['coinacceptor']['show_credits'],
        ],
        'coinacceptor_ascii_coin_map' => [
            'view' => 'advanced',
            'type' => 'input',
            'placeholder' => 'COIN1:10,COIN2:50,COIN3:100',
            'name' => 'coinacceptor[ascii_coin_map]',
            'value' => $config['coinacceptor']['ascii_coin_map'],
        ],
    ],
    'sound' => [
        'view' => 'basic',
